...
<div class="row">
    <div class="col-12 col-lg-3">
        <fieldset id="fieldset-crop" class="options-form">
            ...
            <div>
                <?php echo $this->form->renderField('x-axis'); ?>
                <?php echo $this->form->renderField('y-axis'); ?>
...
<script>
    ...
    const cropper = new Cropper(image,{
        ...
        autoCropArea: 1,
        crop(event) {
            document.getElementById("jform_x_axis").value = event.detail.x
            document.getElementById("jform_y_axis").value = event.detail.y
            document.getElementById("jform_width").value = event.detail.width
            document.getElementById("jform_height").value = event.detail.height
